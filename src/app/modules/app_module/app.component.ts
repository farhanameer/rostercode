...
import { ConfigureNotificationService } from '../nms/services/configure-notifications.service';
import { Router, NavigationEnd } from '@angular/router';
import { AllowNotificationsService } from '../nms/services/allow-notifications.service';
...
export class AppComponent {
  ...
  constructor(private allowNotification: AllowNotificationsService) {}
  ngOnInit() {
    this.siteConfig = JSON.stringify(config);
    $("#loader-body").show();
    this.hrLogin();
    this.allowNotification.init();
  }
